...
<xsl:import href="./bamu-style.xsl" />
...
<xsl:param name="latex.preamble.late">
  ...
  <xsl:text>\AtBeginEnvironment{tableptx}{\vskip\baselineskip}&#xa;</xsl:text>
  <xsl:text>\AfterEndEnvironment{tableptx}{\vskip\baselineskip}&#xa;</xsl:text>

  <xsl:text>\AfterEndEnvironment{figureptx}{\vskip\baselineskip}&#xa;</xsl:text>
  <xsl:text>\AtBeginEnvironment{figureptx}{\vskip\baselineskip}&#xa;</xsl:text>

  <!-- <xsl:text>\AfterEndEnvironment{sidebyside}{\vskip\baselineskip}&#xa;</xsl:text> -->
  <xsl:text>\AtBeginEnvironment{sidebyside}{\vskip\baselineskip}&#xa;</xsl:text>
